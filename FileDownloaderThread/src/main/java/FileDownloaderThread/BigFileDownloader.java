...
public class BigFileDownloader {
    ...
    public final AtomicBoolean taskCanceled=new AtomicBoolean (false);
    ...
    public BigFileDownloader(String strUrl) throws Exception {
        ...
        //获取待下载资源的大小
        fileSize=retieverFileSize(requestURL);
     ...
     * @throws Exception
     */
    private long retieverFileSize(URL requestURL) throws Exception {
        long size       =-1;
        ...
        try {
            ...
            //从响应的Response中通过Content-Length获取下载文件大小
